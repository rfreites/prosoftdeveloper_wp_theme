 ...
 */
function helloronny_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'helloronny_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.helloronny-front-page) .entry-title,
...
.colors-custom .helloronny-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.helloronny-front-page .panel-content .recent-posts article,
...
.colors-custom.helloronny-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'helloronny_custom_colors_css', $css, $hue, $saturation );
}
